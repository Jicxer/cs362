...
# ====================================================================American Express Testing============================================================================== ## noqa: E501
    ...
    # Verifies a valid American Express card with valid length and prefix of max 37 # noqa: E501
    # Created manually by placing correct length and prefix
    def test_valid_americanexp2(self):
        a = 379869244557805
        self.assertFalse(credit_card_validator(a), message)

    # Verifies a valid American Express card with valid length and prefix within middle of range of accepted values 35 # noqa: E501
    # Created manually by placing correct length and prefix
    ...
    # Verifies an invalid American Express card with valid length but prefix outside of min range of 34: 33 # noqa: E501
    # Created manually by placing correct length and invalid prefix
    def test_invalid_americanexp2(self):
        a = 33986924455780
        self.assertFalse(credit_card_validator(a), message)

    # Verifies an invalid American Express card with valid length but prefix outside of max range of 37: 38 # noqa: E501
    # Created manually by placing correct length and invalid prefix
    def test_invalid_americanexp3(self):
        a = 38986924455780
        self.assertFalse(credit_card_validator(a), message)

    # Verifies an invalid American Express card with invalid length of 16 and valid prefix within range 34 - 37 # noqa: E501
    # Created manually by placing correct length and invalid prefix
    def test_invalid_americanexp4(self):
        a = 35620700136113
        self.assertFalse(credit_card_validator(a), message)

    # Verifies a American Express card with invalid length of 16 and valid prefix # noqa: E501
...
# ====================================================================Mastercard Testing============================================================================== ## noqa: E501
    ...
    # Verifies a Master Card type 1 with valid length and an invalid prefix outside of range: 50 # noqa: E501
    # Number created manually by placing prefix into an old generated number
    def test_invalid_mastercard1(self):
        a = 5000074903653800
        self.assertFalse(credit_card_validator(a), message)

    # Verifies a Master Card type 1 with valid length and an invalid prefix outside of range: 56 # noqa: E501
    # Number created manually by placing prefix into an old generated number
    def test_invalid_mastercard2(self):
        a = 5600074903653800
        self.assertFalse(credit_card_validator(a), message)

    # Verifies a Master Card type 2 with valid length and an invalid prefix outside of range: 2220 # noqa: E501
    # Number created manually by placing prefix into an old generated number
    def test_invalid_mastercard3(self):
        a = 2220074903653800
        self.assertFalse(credit_card_validator(a), message)

    # Verifies a Master Card type 2 with valid length and an invalid prefix outside of range: 2721 # noqa: E501
    # Number created manually by placing prefix into an old generated number
    ...
    # Verifies a Master Card type 2 with invalid length of 14 and valid prefix
    # Number created manually by using an old number from a random card generator and changing the prefix # noqa: E501
    # https://bestccgen.com/master-card-generator.php
